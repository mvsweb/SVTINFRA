...
?>
        ...
        <div class="page-content">
            ...
            <!-- OUR MISSION START -->
            <div id="vision-mission" class="section-full mobile-page-padding mission-outer-section  p-t80 p-b30 bg-gray bg-no-repeat bg-right-center" style="background-image:url(images/left-men.png), url(images/background/bg-4.png); ">
				<div class="section-content">
                    <div class="container">
                        <!-- TITLE START -->
                        <div class="section-head"> 
                            <div class="mt-separator-outer separator-center">
                                <div class="mt-separator">
                                    <h2 class="text-uppercase sep-line-one "><span class="font-weight-300 text-primary">Our</span>Vision & Mission</h2>
                                </div>
                            </div>
                        </div>                  
                        <!-- TITLE END -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="contact-home1-left bg-dark p-a30 m-b0">
                                    ...
                                    <form class="cons-contact-form2 form-transparent" method="POST" action="contact-mail.php">
            ...
            <!-- OUR SERVICES START -->
            <div id="services" class="section-full mobile-page-padding  p-b50  square_shape2">
				<div class="section-content">
                ...
                <div class="container">
						...
						<div class="section-content">
							<div class="call-us-section text-center">
                                ...
                                <a href="#" class="site-button-secondry btn-effect bg-dark">Contact Us</a>
							</div>
						</div>
             ...
             <div class="section-full mobile-page-padding p-t80 p-b30 square_shape1 bg-parallax bg-cover"  data-stellar-background-ratio="0.5" style="background-image:url(images/background/bg5.jpg);">
                        <div class="container">
                            ...
                            <div class="section-head ">
                                <div class="mt-separator-outer separator-center">
                                    <div class="mt-separator">
                                        <h2 class="text-white text-uppercase sep-line-one "><span class="font-weight-300 text-primary" >Latest</span> Product</h2>
                                    </div>
                                </div>
                            </div>                   
                            <!-- TITLE END --> 
